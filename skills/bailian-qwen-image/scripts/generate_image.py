...
Usage:
  ...
  python scripts/generate_image.py --file request.json --output output/images/cat.png
"""
...
def main() -> None:
    ...
    parser.add_argument("--output", default="output/images/output.png", help="Output image path")
